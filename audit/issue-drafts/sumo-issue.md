...
2. **Essence-level theory**: not attributable, since the axioms fix content and inferential role, not what desiring essentially is.
...
in one triple: `sumo:desires odsr:deliberatelyUncommittedOn odsr:FamilyAxis .`
